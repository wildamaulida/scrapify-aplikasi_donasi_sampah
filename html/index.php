...
<body class="bg-gray-100">
    <!-- admin-navbar.php -->
    <?php include 'member-navbar2.php'; ?>
    ...
    <section id="services" class="py-20 bg-gray-100">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-10 animate-slide-in">Apa yang Ingin Anda Lakukan?</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                <a href="#" 
                   class="block bg-white p-6 rounded-lg shadow-lg text-center card hover:shadow-xl transform hover:scale-105 transition duration-300 animate-slide-in">
                    ...
                    <p>Layanan pengelolaan sampah yang dapat diandalkan dengan opsi pengantaran langsung atau penjemputan sampah.</p>
                </a>
                <a href="#" 
                   class="block bg-white p-6 rounded-lg shadow-lg text-center card hover:shadow-xl transform hover:scale-105 transition duration-300 animate-slide-in">
                    <div class="relative">
                    ...
                    <p>Dengan teknologi AI, Anda dapat mengajukan berbagai pertanyaan dan mendapatkan jawaban atau saran terkit pengelolaan sampah.</p>
                </a>
                <a href="#" 
                   class="block bg-white p-6 rounded-lg shadow-lg text-center card hover:shadow-xl transform hover:scale-105 transition duration-300 animate-slide-in">
                    <div class="relative">
    ...
    <section id="about-scrapify" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-10 animate-slide-in">Tentang Scrapify</h2>
            <div class="grid md:grid-cols-2 gap-10 items-center">
                <div class="animate-slide-in">
                    <h3 class="text-2xl font-semibold mb-4 text-green-600">Solusi Pintar Pengelolaan Sampah</h3>
                    <p class="text-gray-700 mb-4">
                        Scrapify adalah platform inovatif yang bertujuan untuk mengubah cara masyarakat mengelola dan mendaur ulang sampah. Kami menyediakan solusi komprehensif yang memudahkan setiap individu untuk berkontribusi pada lingkungan yang lebih bersih dan berkelanjutan.
                    </p>
                ...
                <div class="animate-slide-in">
                    <div class="bg-green-100 p-6 rounded-lg shadow-lg">
                        <h4 class="text-xl font-semibold mb-4 text-green-700">Hubungi Kami</h4>
                        <div class="space-y-3">
                            ...
                            <div class="flex space-x-4 mt-4">
                                ...
                                <a href="#" class="text-green-600 hover:text-green-800"><i class="fab fa-facebook text-2xl"></i></a>
    ...
    <script>
        ...
        function showAlert() {
            alert("Anda harus login terlebih dahulu untuk menikmati layanan kami :D");
        }
        ...
        window.onload = function() {
            ...
            if (servicesElement) {
                servicesElement.addEventListener("click", showAlert);
            }
        };
